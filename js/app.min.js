                ...
                ! function (e) {
                    ...
                    function l(e, t) {
                        var s = e.getBoundingClientRect(),
                            ...
                            i = n.documentElement,
                            r = v(n);
                        return /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (r.x = 0), t ? s.top + r.y - i.clientTop : s.left + r.x - i.clientLeft
                    }
                    ...
                    function L(e, t, s, n) {
                        ...
                        var i = T(n, e),
                            r = e[i - 1],
                            a = e[i];
                        return s ? n - r > (a - r) / 2 ? a : r : t[i - 1] ? e[i - 1] + o(n - e[i - 1], t[i - 1]) : n
                    }
                    var k, P;
                    e.PipsMode = void 0, (P = e.PipsMode || (e.PipsMode = {})).Range = "range", P.Steps = "steps", P.Positions = "positions", P.Count = "count", P.Values = "values", e.PipsType = void 0, (k = e.PipsType || (e.PipsType = {}))[k.None = -1] = "None", k[k.NoValue = 0] = "NoValue", k[k.LargeValue = 1] = "LargeValue", k[k.SmallValue = 2] = "SmallValue";
                    var _ = function () {
                            function e(e, t, s) {
                                var n;
                            ...
                            return e.prototype.getDistance = function (e) {
                                ...
                                var r = 1,
                                    ...
                                    c = 0,
                                    d = 0;
                                for (n = s ? (e - this.xPct[i]) / (this.xPct[i + 1] - this.xPct[i]) : (this.xPct[i + 1] - e) / (this.xPct[i + 1] - this.xPct[i]); a > 0;) o = this.xPct[i + 1 + d] - this.xPct[i + d], t[i + d] * r + 100 - 100 * n > 100 ? (l = o * n, r = (a - 100 * n) / t[i + d], n = 1) : (l = t[i + d] * o / 100 * r, r = 0), s ? (c -= l, this.xPct.length + d >= 1 && d--) : (c += l, this.xPct.length - d >= 1 && d++), a = t[i + d] * r;
                                return e + c
                                ...
                                var n = T(e, this.xPct);
                                return (100 === e || t && e === this.xPct[n - 1]) && (n = Math.max(n - 1, 1)), (this.xVal[n] - this.xVal[n - 1]) / s
                                ...
                                var n = Number(t[1]);
                                s ? this.xSteps.push(!isNaN(n) && n) : isNaN(n) || (this.xSteps[0] = n), this.xHighestCompleteStep.push(0)
                    ...
                    function X(e, t) {
                        ...
                        if (0 !== t) {
                            ...
                            var n = t[0] + t[1],
                                i = e.spectrum.xVal[0];
                            if (n / (e.spectrum.xVal[e.spectrum.xVal.length - 1] - i) > 1) throw new Error("noUiSlider: 'padding' option must not exceed 100% of the range.")
                        }
                    }
                    ...
                    function re(e) {
                        ...
                        e.format && !e.ariaFormat && (e.ariaFormat = e.format), Object.keys(s).forEach((function (r) {
                            if (i(e[r]) || void 0 !== n[r]) s[r].t(t, i(e[r]) ? e[r] : n[r]);
                    ...
                    function ae(t, s, o) {
                        ...
                        function q(e, t) {
                            var n = j(e, s.cssClasses.origin),
                                i = j(n, s.cssClasses.handle);
                            if (j(i, s.cssClasses.touchArea), i.setAttribute("data-handle", String(t)), s.keyboardSupport && (i.setAttribute("tabindex", "0"), i.addEventListener("keydown", (function (e) {
                                    return fe(e, t)
                            ...
                            return i.setAttribute("role", "slider"), i.setAttribute("aria-orientation", s.ort ? "vertical" : "horizontal"), 0 === t ? h(i, s.cssClasses.handleLower) : t === s.handles - 1 && h(i, s.cssClasses.handleUpper), n
                        }
                        ...
                        function z(e, t) {
                            ...
                            f = [], (S = []).push(B(n, e[0]));
                            for (var i = 0; i < s.handles; i++) f.push(q(t, i)), P[i] = i, S.push(B(n, e[i + 1]))
                        }

                        function H(e) {
                            return h(e, s.cssClasses.target), 0 === s.dir ? h(e, s.cssClasses.ltr) : h(e, s.cssClasses.rtl), 0 === s.ort ? h(e, s.cssClasses.horizontal) : h(e, s.cssClasses.vertical), h(e, "rtl" === getComputedStyle(e).direction ? s.cssClasses.textDirectionRtl : s.cssClasses.textDirectionLtr), j(e, s.cssClasses.base)
                        }

                        function W(e, t) {
                            return !(!s.tooltips || !s.tooltips[t]) && j(e.firstChild, s.cssClasses.tooltip)
                        }
                        ...
                        function U() {
                            R(), C = f.map(W), me("update" + D.tooltips, (function (e, t, n) {
                                if (C && s.tooltips && !1 !== C[t]) {
                                    var i = e[t];
                                    !0 !== s.tooltips[t] && (i = s.tooltips[t].to(n[t])), C[t].innerHTML = i
                                }
                            }))
                        }

                        function X() {
                            ve("update" + D.aria), me("update" + D.aria, (function (e, t, n, i, r) {
                                P.forEach((function (e) {
                                    ...
                                    i = O.fromStepping(i).toFixed(1), a = O.fromStepping(a).toFixed(1), o = O.fromStepping(o).toFixed(1), t.children[0].setAttribute("aria-valuemin", i), t.children[0].setAttribute("aria-valuemax", a), t.children[0].setAttribute("aria-valuenow", o), t.children[0].setAttribute("aria-valuetext", l)
                                }))
                            }))
                        }

                        function Y(t) {
                            if (t.mode === e.PipsMode.Range || t.mode === e.PipsMode.Steps) return O.xVal;
                            if (t.mode === e.PipsMode.Count) {
                                if (t.values < 2) throw new Error("noUiSlider: 'values' (>= 2) required for mode 'count'.");
                                for (var s = t.values - 1, n = 100 / s, i = []; s--;) i[s] = s * n;
                        ...
                        function Q(t) {
                            ...
                            return (n = a(n.slice().sort((function (e, t) {
                                ...
                                var o, u, p, f, h, m, g, v, b, y, w = r,
                                    S = n[a + 1],
                                    x = t.mode === e.PipsMode.Steps;
                                for (x && (o = O.xNumSteps[a]), o || (o = S - w), void 0 === S && (S = w), o = Math.max(o, 1e-7), u = w; u <= S; u = s(u, o)) {
                                    for (v = (h = (f = O.toStepping(u)) - d) / (t.density || 1), y = h / (b = Math.round(v)), p = 1; p <= b; p += 1) i[(m = d + p * y).toFixed(5)] = [O.fromStepping(m), 0];
                                    g = n.indexOf(u) > -1 ? e.PipsType.LargeValue : x ? e.PipsType.SmallValue : e.PipsType.NoValue, !a && l && u !== S && (g = 0), u === S && c || (i[f.toFixed(5)] = [u, g]), d = f
                                }
                            })), i
                        }

                        function J(t, n, i) {
                            var r, a, o = $.createElement("div"),
                            ...
                            function f(t, r, a) {
                                if ((a = n ? n(r, a) : a) !== e.PipsType.None) {
                                    var l = j(o, !1);
                                    l.className = p(a, s.cssClasses.marker), l.style[s.style] = t + "%", a > e.PipsType.NoValue && ((l = j(o, !1)).className = p(a, s.cssClasses.value), l.setAttribute("data-value", String(r)), l.style[s.style] = t + "%", l.innerHTML = String(i.to(r)))
                                }
                            }
                            return h(o, s.cssClasses.pips), h(o, 0 === s.ort ? s.cssClasses.pipsHorizontal : s.cssClasses.pipsVertical), Object.keys(t).forEach((function (e) {
                                f(e, t[e][0], t[e][1])
                            })), o
                        }
                        ...
                        function ee(e) {
                            ...
                            return x = A.appendChild(J(t, s, n))
                        }
                        ...
                        function se(e, t, n, i) {
                            var r = function (r) {
                                    ...
                                    return !!a && !(F() && !i.doNotReject) && !(g(A, s.cssClasses.tap) && !i.doNotReject) && !(e === E.start && void 0 !== a.buttons && a.buttons > 1) && (!i.hover || !a.buttons) && (T || a.preventDefault(), a.calcPoint = a.points[s.ort], void n(a, i))
                                },
                                a = [];
                            return e.split(" ").forEach((function (e) {
                                t.addEventListener(e, r, !!T && {
                                    passive: !0
                                }), a.push([e, r])
                            })), a
                        }
                        ...
                        function ne(e, t, s) {
                            ...
                            if (n) {
                                var l = function (t) {
                                    var n = t.target;
                                    return n === s || s.contains(n) || e.composed && e.composedPath().shift() === s
                                };
                            ...
                            return t = t || v($), (i || r) && (a = e.clientX + t.x, o = e.clientY + t.y), e.pageOffset = t, e.points = [a, o], e.cursor = i || r, e
                        }
                        ...
                        function ae(e) {
                            ...
                            return f.forEach((function (n, i) {
                                if (!G(i)) {
                                    var r = k[i],
                                        a = Math.abs(r - e);
                                    (a < t || a <= t && e > r || 100 === a && 100 === t) && (s = i, t = a)
                                }
                            })), s
                        }
                        ...
                        function le(e, t) {
                            ...
                            Se(n > 0, 100 * n / t.baseSize, t.locations, t.handleNumbers, t.connect)
                        }

                        function ce(e, t) {
                            t.handle && (m(t.handle, s.cssClasses.active), _ -= 1), t.listeners.forEach((function (e) {
                                I.removeEventListener(e[0], e[1])
                            })), 0 === _ && (m(A, s.cssClasses.drag), Ee(), e.cursor && (N.style.cursor = "", N.removeEventListener("selectstart", r))), t.handleNumbers.forEach((function (e) {
                        ...
                        function de(e, t) {
                            if (!t.handleNumbers.some(G)) {
                                var n;
                                1 === t.handleNumbers.length && (n = f[t.handleNumbers[0]].children[0], _ += 1, h(n, s.cssClasses.active)), e.stopPropagation();
                                var i = [],
                                    a = se(E.move, I, le, {
                                        target: e.target,
                                        handle: n,
                                ...
                                i.push.apply(i, a.concat(o, l)), e.cursor && (N.style.cursor = getComputedStyle(e.target).cursor, f.length > 1 && h(A, s.cssClasses.drag), N.addEventListener("selectstart", r, !1)), t.handleNumbers.forEach((function (e) {
                                    be("start", e)
                                }))
                            }
                        }
                        ...
                        function ue(e) {
                            ...
                            var t = ie(e.calcPoint),
                                n = ae(t);
                            !1 !== n && (s.events.snap || d(A, s.cssClasses.tap, s.animationDuration), Te(n, t, !0, !0), Ee(), be("slide", n, !0), be("update", n, !0), s.events.snap ? de(e, {
                                handleNumbers: [n]
                        ...
                        function fe(e, t) {
                            ...
                            if (e.preventDefault(), p || u) {
                                var m = u ? 0 : 1,
                                    g = $e(t)[m];
                                if (null === g) return !1;
                                !1 === g && (g = O.getDefaultStep(k[t], u, s.keyboardDefaultStep)), g *= d || c ? s.keyboardPageMultiplier : s.keyboardMultiplier, g = Math.max(g, 1e-7), g *= u ? -1 : 1, o = L[t] + g
                            } else o = h ? s.spectrum.xVal[s.spectrum.xVal.length - 1] : s.spectrum.xVal[0];
                            return Te(t, O.toStepping(o), !0, !0), be("slide", t), be("update", t), be("change", t), be("set", t), !1
                        }

                        function he(e) {
                            e.fixed || f.forEach((function (e, t) {
                                se(E.start, e.children[0], de, {
                                    handleNumbers: [t]
                                })
                            })), e.tap && se(E.start, c, ue, {}), e.hover && se(E.move, c, pe, {
                                hover: !0
                            }), e.drag && S.forEach((function (t, n) {
                                if (!1 !== t && 0 !== n && n !== S.length - 1) {
                                    var i = f[n - 1],
                                        ...
                                        o = [i, r],
                                        l = [n - 1, n];
                                    h(t, s.cssClasses.draggable), e.fixed && (a.push(i.children[0]), a.push(r.children[0])), e.dragAll && (o = f, l = P), a.forEach((function (e) {
                                        se(E.start, e, de, {
                                            handles: o,
                                            handleNumbers: l,
                                            connect: t
                        ...
                        function me(e, t) {
                            M[e] = M[e] || [], M[e].push(t), "update" === e.split(".")[0] && f.forEach((function (e, t) {
                                be("update", t)
                            }))
                        }
                        ...
                        function ve(e) {
                            ...
                            Object.keys(M).forEach((function (e) {
                                ...
                                t && t !== n || s && s !== i || ge(i) && s !== i || delete M[e]
                            }))
                        }
                        ...
                        function be(e, t, n) {
                            Object.keys(M).forEach((function (i) {
                                var r = i.split(".")[0];
                                e === r && M[i].forEach((function (e) {
                                    e.call(Ve, L.map(s.format.to), t, L.slice(), n || !1, k.slice(), Ve)
                                }))
                            }))
                        }
                        ...
                        function Se(e, t, s, n, i) {
                            var r = s.slice(),
                                ...
                                o = [!e, e],
                                l = [e, !e];
                            n = n.slice(), e && n.reverse(), n.length > 1 ? n.forEach((function (e, s) {
                        ...
                        function Ce(e, t) {
                            k[e] = t, L[e] = O.fromStepping(t);
                            var n = "translate(" + we(xe(t, 0) - V + "%", "0") + ")";
                            f[e].style[s.transformRule] = n, Ae(e), Ae(e + 1)
                        }
                        ...
                        function Te(e, t, s, n, i) {
                            return i || (t = ye(k, e, t, s, n, !1)), !1 !== t && (Ce(e, t), !0)
                        }
                        ...
                        function Ae(e) {
                            if (S[e]) {
                                var t = 0,
                                    n = 100;
                                0 !== e && (t = k[e - 1]), e !== S.length - 1 && (n = k[e]);
                                var i = n - t,
                        ...
                        function Oe(e, t) {
                            return null === e || !1 === e || void 0 === e ? k[t] : ("number" == typeof e && (e = String(e)), !1 !== (e = s.format.from(e)) && (e = O.toStepping(e)), !1 === e || isNaN(e) ? k[t] : e)
                        }

                        function Le(e, t, n) {
                            var i = p(e),
                                r = void 0 === k[0];
                            t = void 0 === t || t, s.animate && !r && d(A, s.cssClasses.tap, s.animationDuration), P.forEach((function (e) {
                                Te(e, Oe(i[e], e), !0, !1, n)
                            }));
                            var a = 1 === P.length ? 0 : 1;
                            if (r && O.hasNoSize() && (n = !0, k[0] = 0, P.length > 1)) {
                                var o = 100 / (P.length - 1);
                                P.forEach((function (e) {
                                    k[e] = e * o
                                }))
                            }
                            for (; a < P.length; ++a) P.forEach((function (e) {
                                Te(e, k[e], !0, !0, n)
                            }));
                        ...
                        function Pe(e, t, s, n) {
                            ...
                            Te(e, Oe(t, e), !0, !0, n), be("update", e), s && be("set", e)
                        }

                        function _e(e) {
                            if (void 0 === e && (e = !1), e) return 1 === L.length ? L[0] : L.slice(0);
                            var t = L.map(s.format.to);
                            return 1 === t.length ? t[0] : t
                        }

                        function Me() {
                            for (ve(D.aria), ve(D.tooltips), Object.keys(s.cssClasses).forEach((function (e) {
                                    m(A, s.cssClasses[e])
                        ...
                        function Ie(e, t) {
                            ...
                            r.forEach((function (t) {
                                void 0 !== e[t] && (s[t] = a[t])
                            })), O = a.spectrum, s.margin = a.margin, s.limit = a.limit, s.padding = a.padding, s.pips ? ee(s.pips) : Z(), s.tooltips ? U() : R(), k = [], Le(i(e.start) ? e.start : n, t)
                        }

                        function Ne() {
                            c = H(A), z(s.connect, c), he(s.events), Le(s.start), s.pips && ee(s.pips), s.tooltips && U(), X()
                        }
                        Ne();
                        var Ve = {
                            destroy: Me,
                    ...
                    e.create = oe, e.cssClasses = $, e.default = le, Object.defineProperty(e, "__esModule", {
                        value: !0
                    })
                }(t)
            }
    ...
    function s(n) {
        ...
        let d = {
            ...
            formClean(e) {
                ...
                for (let e = 0; e < t.length; e++) {
                    const s = t[e];
                    s.parentElement.classList.remove("_focus"), s.classList.remove("_focus"), s.value = s.dataset.placeholder
                }
        ...
        const u = document.querySelectorAll("select"),
            p = {
                selectClasses: {
                    classSelect: "select",
                ...
                getSelectElement: (e, t) => ({
                    ...
                    selectElement: e.querySelector(p.getSelectClass(t))
                }),
                selectsInit(e) {
                    e.forEach(((e, t) => {
                        e.dataset.id = t, p.selectInit(e)
                    })), document.addEventListener("click", p.selectsActions), document.addEventListener("keydown", p.selectsActions), document.addEventListener("focusin", p.selectsActions), document.addEventListener("focusout", p.selectsActions)
                },
                selectInit(e) {
                    let t = document.createElement("div");
                    if (t.classList.add(p.selectClasses.classSelect), e.parentNode.insertBefore(t, e), t.appendChild(e), e.hidden = !0, t.insertAdjacentHTML("beforeend", `<div class="${p.selectClasses.classSelectBody}"><div hidden class="${p.selectClasses.classSelectOptions}"></div></div>`), p.selectBuild(e), p.getSelectPlaceholder(e) && (e.dataset.placeholder = p.getSelectPlaceholder(e).value, p.getSelectPlaceholder(e).label.show)) {
                        p.getSelectElement(t, p.selectClasses.classSelectTitle).selectElement.insertAdjacentHTML("afterbegin", `<span class="${p.selectClasses.classSelectLabel}">${p.getSelectPlaceholder(e).label.text?p.getSelectPlaceholder(e).label.text:p.getSelectPlaceholder(e).value}</span>`)
                    }
                    e.dataset.speed = e.dataset.speed ? e.dataset.speed : "150", e.addEventListener("change", p.selectChange)
                },
                selectBuild(e) {
                    const t = e.parentElement;
                    t.dataset.id = e.dataset.id, t.classList.add(e.getAttribute("class") ? `select_${e.getAttribute("class")}` : ""), e.multiple ? t.classList.add(p.selectClasses.classSelectMultiple) : t.classList.remove(p.selectClasses.classSelectMultiple), e.hasAttribute("data-checkbox") && e.multiple ? t.classList.add(p.selectClasses.classSelectCheckBox) : t.classList.remove(p.selectClasses.classSelectCheckBox), p.setSelectTitleValue(t, e), p.setOptions(t, e), e.hasAttribute("data-search") && p.searchActions(t), e.hasAttribute("data-open") && p.selectAction(t), p.selectDisabled(t, e)
                },
                selectsActions(e) {
                    const t = e.target,
                        s = e.type;
                    if (t.closest(p.getSelectClass(p.selectClasses.classSelect)) || t.closest(p.getSelectClass(p.selectClasses.classSelectTag))) {
                        const n = t.closest(".select") ? t.closest(".select") : document.querySelector(`.${p.selectClasses.classSelect}[data-id="${t.closest(p.getSelectClass(p.selectClasses.classSelectTag)).dataset.selectId}"]`),
                            i = p.getSelectElement(n).originalSelect;
                        if ("click" === s) {
                            if (!i.disabled)
                                if (t.closest(p.getSelectClass(p.selectClasses.classSelectTag))) {
                                    const e = t.closest(p.getSelectClass(p.selectClasses.classSelectTag)),
                                        s = document.querySelector(`.${p.selectClasses.classSelect}[data-id="${e.dataset.selectId}"] .select__option[data-value="${e.dataset.value}"]`);
                                    p.optionAction(n, i, s)
                                } else if (t.closest(p.getSelectClass(p.selectClasses.classSelectTitle))) p.selectAction(n);
                            else if (t.closest(p.getSelectClass(p.selectClasses.classSelectOption))) {
                                const e = t.closest(p.getSelectClass(p.selectClasses.classSelectOption));
                                p.optionAction(n, i, e)
                            }
                        } else "focusin" === s || "focusout" === s ? t.closest(p.getSelectClass(p.selectClasses.classSelect)) && ("focusin" === s ? n.classList.add(p.selectClasses.classSelectFocus) : n.classList.remove(p.selectClasses.classSelectFocus)) : "keydown" === s && "Escape" === e.code && p.selectsСlose()
                    } else p.selectsСlose()
                },
                selectsСlose() {
                    const e = document.querySelectorAll(`${p.getSelectClass(p.selectClasses.classSelect)}${p.getSelectClass(p.selectClasses.classSelectOpen)}`);
                    e.length && e.forEach((e => {
                        p.selectAction(e)
                    }))
                },
                selectAction(e) {
                    const t = p.getSelectElement(e).originalSelect,
                        s = p.getSelectElement(e, p.selectClasses.classSelectOptions).selectElement;
                    s.classList.contains("_slide") || (e.classList.toggle(p.selectClasses.classSelectOpen), a(s, t.dataset.speed))
                },
                setSelectTitleValue(e, t) {
                    const s = p.getSelectElement(e, p.selectClasses.classSelectBody).selectElement,
                        n = p.getSelectElement(e, p.selectClasses.classSelectTitle).selectElement;
                    n && n.remove(), s.insertAdjacentHTML("afterbegin", p.getSelectTitleValue(e, t))
                },
                getSelectTitleValue(e, t) {
                    let s = p.getSelectedOptionsData(t, 2).html;
                    if (t.multiple && t.hasAttribute("data-tags") && (s = p.getSelectedOptionsData(t).elements.map((t => `<span role="button" data-select-id="${e.dataset.id}" data-value="${t.value}" class="_select-tag">${p.getSelectElementContent(t)}</span>`)).join(""), t.dataset.tags && document.querySelector(t.dataset.tags) && (document.querySelector(t.dataset.tags).innerHTML = s, t.hasAttribute("data-search") && (s = !1))), s = s.length ? s : t.dataset.placeholder, p.getSelectedOptionsData(t).values.length ? e.classList.add(p.selectClasses.classSelectActive) : e.classList.remove(p.selectClasses.classSelectActive), t.hasAttribute("data-search")) return `<div class="${p.selectClasses.classSelectTitle}"><span class="${p.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${s}" data-placeholder="${s}" class="${p.selectClasses.classSelectInput}"></span></div>`; {
                        const e = p.getSelectedOptionsData(t).elements.length && p.getSelectedOptionsData(t).elements[0].dataset.class ? ` ${p.getSelectedOptionsData(t).elements[0].dataset.class}` : "";
                        return `<button type="button" class="${p.selectClasses.classSelectTitle}"><span class="${p.selectClasses.classSelectValue}"><span class="${p.selectClasses.classSelectContent}${e}">${s}</span></span></button>`
                    }
                },
                getSelectElementContent(e) {
                    ...
                    let n = "";
                    return n += t ? `<span class="${p.selectClasses.classSelectRow}">` : "", n += t ? `<span class="${p.selectClasses.classSelectData}">` : "", n += t ? s : "", n += t ? "</span>" : "", n += t ? `<span class="${p.selectClasses.classSelectText}">` : "", n += e.textContent, n += t ? "</span>" : "", n += t ? "</span>" : "", n
                },
                ...
                getSelectedOptionsData(e, t) {
                    ...
                    return e.multiple ? s = Array.from(e.options).filter((e => e.value)).filter((e => e.selected)) : s.push(e.options[e.selectedIndex]), {
                        ...
                        html: s.map((e => p.getSelectElementContent(e)))
                    }
                },
                getOptions(e) {
                    ...
                    if (n.length > 0) {
                        let i = "";
                        return (p.getSelectPlaceholder(e) && !p.getSelectPlaceholder(e).show || e.multiple) && (n = n.filter((e => e.value))), i += t ? `<div ${t} ${s} class="${p.selectClasses.classSelectOptionsScroll}">` : "", n.forEach((t => {
                            i += p.getOption(t, e)
                        })), i += t ? "</div>" : "", i
                    }
                },
                getOption(e, t) {
                    const s = e.selected && t.multiple ? ` ${p.selectClasses.classSelectOptionSelected}` : "",
                        n = e.selected && !t.hasAttribute("data-show-selected") ? "hidden" : "",
                        i = e.dataset.class ? ` ${e.dataset.class}` : "";
                    let r = "";
                    return r += `<button ${n} class="${p.selectClasses.classSelectOption}${i}${s}" data-value="${e.value}" type="button">`, r += p.getSelectElementContent(e), r += "</button>", r
                },
                setOptions(e, t) {
                    p.getSelectElement(e, p.selectClasses.classSelectOptions).selectElement.innerHTML = p.getOptions(t)
                },
                optionAction(e, t, s) {
                    if (t.multiple) {
                        s.classList.toggle(p.selectClasses.classSelectOptionSelected);
                        p.getSelectedOptionsData(t).elements.forEach((e => {
                            e.removeAttribute("selected")
                        }));
                        e.querySelectorAll(p.getSelectClass(p.selectClasses.classSelectOptionSelected)).forEach((e => {
                            t.querySelector(`option[value="${e.dataset.value}"]`).setAttribute("selected", "selected")
                        }))
                    } else t.hasAttribute("data-show-selected") || (e.querySelector(`${p.getSelectClass(p.selectClasses.classSelectOption)}[hidden]`) && (e.querySelector(`${p.getSelectClass(p.selectClasses.classSelectOption)}[hidden]`).hidden = !1), s.hidden = !0), t.value = s.hasAttribute("data-value") ? s.dataset.value : s.textContent, p.selectAction(e);
                    p.setSelectTitleValue(e, t), p.setSelectChange(t)
                },
                selectChange(e) {
                    p.selectBuild(e.target), p.setSelectChange(e.target)
                },
                setSelectChange(e) {
                    const t = e.parentElement;
                    p.selectCallback(t, e)
                },
                selectDisabled(e, t) {
                    t.disabled ? (e.classList.add(p.selectClasses.classSelectDisabled), p.getSelectElement(e, p.selectClasses.classSelectTitle).selectElement.disabled = !0) : (e.classList.remove(p.selectClasses.classSelectDisabled), p.getSelectElement(e, p.selectClasses.classSelectTitle).selectElement.disabled = !1)
                },
                searchActions(e) {
                    p.getSelectElement(e).originalSelect;
                    const t = p.getSelectElement(e, p.selectClasses.classSelectInput).selectElement,
                        s = p.getSelectElement(e, p.selectClasses.classSelectOptions).selectElement,
                        n = s.querySelectorAll(`.${p.selectClasses.classSelectOption}`);
                    t.addEventListener("input", (function (i) {
                        n.forEach((e => {
                            e.textContent.toUpperCase().indexOf(t.value.toUpperCase()) >= 0 ? e.hidden = !1 : e.hidden = !0
                        })), !0 === s.hidden && p.selectAction(e)
                    }))
                },
                selectCallback(e, t) {},
                setLogging(e) {
        ...
        u.length ? p.selectsInit(u) : p.setLogging("Нет ни одного select, модуль можно отключить");
        var f = s(211);
        let h;
                ...
                return t = e, (s = [{
                    ...
                    value: function () {
                        document.addEventListener("click", function (e) {
                            ...
                            if (!this._isMoved && t) {
                                ...
                                var s = this.starter.getAttribute(this.config.linkAttributeName);
                                return this._nextWindows = document.querySelector(s), void this.open()
                            }
                    ...
                    value: function (e) {
                        ...
                        if (this.openedWindow.contains(document.activeElement)) {
                            ...
                            console.log(n), e.shiftKey && 0 === n && (s[s.length - 1].focus(), e.preventDefault()), e.shiftKey || n !== s.length - 1 || (s[0].focus(), e.preventDefault())
                    ...
                    value: function () {
                        if (this.config.backscroll) {
                            ...
                            var s = window.innerWidth - t.clientWidth;
                            t.style.top = -this._scrollPosition + "px", s && (t.style.marginRight = s + "px", e.map((function (e) {
                                e.style.marginRight = parseInt(getComputedStyle(e).marginRight) + s + "px"
                            }))), t.classList.add("hystmodal__opened")
                        }
                    }
                }]) && i(t.prototype, s), e
            }();
            (a = "_shadow") in (r = o) ? Object.defineProperty(r, a, {
                value: false,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        }, function (e, t, s) {}]), h = new HystModal({
        ...
        }), t() && document.querySelector(`#${t()}`) && h.open(`#${t()}`);
        var y = Math.max,
            w = Math.min,
            S = Math.round;
        ...
        function k(e, t, s) {
            ...
            return (r || !r && !s) && (("body" !== E(t) || L(o)) && (c = (n = t) !== m(n) && v(n) ? {
                scrollLeft: (i = n).scrollLeft,
                scrollTop: i.scrollTop
            } : C(n)), v(t) ? ((d = x(t, !0)).x += t.clientLeft, d.y += t.clientTop) : o && (d.x = A(o))), {
        ...
        function _(e) {
            return "html" === E(e) ? e : e.assignedSlot || e.parentNode || (b(e) ? e.host : null) || T(e)
        }

        function M(e) {
            return ["html", "body", "#document"].indexOf(E(e)) >= 0 ? e.ownerDocument.body : v(e) && L(e) ? e : M(_(e))
        }
        ...
        function N(e) {
            for (var t = m(e), s = I(e); s && D(s) && "static" === O(s).position;) s = I(s);
            return s && ("html" === E(s) || "body" === E(s) && "static" === O(s).position) ? t : s || function (e) {
                var t = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                if (-1 !== navigator.userAgent.indexOf("Trident") && v(e) && "fixed" === O(e).position) return null;
                for (var s = _(e); v(s) && ["html", "body"].indexOf(E(s)) < 0;) {
                    var n = O(s);
                    ...
                    d = {
                        ...
                        setOptions: function (s) {
                            ...
                            u(), o.options = Object.assign({}, r, o.options, i), o.scrollParents = {
                                reference: g(e) ? $(e) : e.contextElement ? $(e.contextElement) : [],
                                popper: $(t)
                            };
                            var a = function (e) {
                                var t = K(e);
                        ...
                        forceUpdate: function () {
                            if (!c) {
                                ...
                                if (J(t, s)) {
                                    o.rects = {
                                        reference: k(t, N(s), "fixed" === o.options.strategy),
                                        popper: P(s)
        ...
        function oe(e) {
            ...
            if (c) {
                var E = N(s),
                    A = "clientHeight",
                    L = "clientWidth";
                if (E === m(s) && "static" !== O(E = T(s)).position && "absolute" === o && (A = "scrollHeight", L = "scrollWidth"), E = E, i === V || (i === B || i === q) && r === F) x = j, v -= (u && C.visualViewport ? C.visualViewport.height : E[A]) - n.height, v *= l ? 1 : -1;
                if (i === B || (i === V || i === j) && r === F) w = q, h -= (u && C.visualViewport ? C.visualViewport.width : E[L]) - n.width, h *= l ? 1 : -1
            }
            var k, P = Object.assign({
                position: o
            }, c && ae);
            return l ? Object.assign({}, P, ((k = {})[x] = y ? "0" : "", k[w] = b ? "0" : "", k.transform = (C.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + v + "px)" : "translate3d(" + h + "px, " + v + "px, 0)", k)) : Object.assign({}, P, ((t = {})[x] = y ? v + "px" : "", t[w] = b ? h + "px" : "", t.transform = "", t))
        }
        const le = {
            name: "applyStyles",
            enabled: !0,
            ...
            fn: function (e) {
                ...
                Object.keys(t.elements).forEach((function (e) {
                    var s = t.styles[e] || {},
                        n = t.attributes[e] || {},
                        i = t.elements[e];
                    v(i) && E(i) && (Object.assign(i.style, s), Object.keys(n).forEach((function (e) {
                        var t = n[e];
                ...
                return Object.assign(t.elements.popper.style, s.popper), t.styles = s, t.elements.arrow && Object.assign(t.elements.arrow.style, s.arrow),
                    function () {
                        Object.keys(t.elements).forEach((function (e) {
                            ...
                            v(n) && E(n) && (Object.assign(n.style, r), Object.keys(i).forEach((function (e) {
                                n.removeAttribute(e)
                            })))
                        }))
                    }
                ...
                var t = e.state,
                    ...
                    a = X.reduce((function (e, s) {
                        return e[s] = function (e, t, s) {
                            var n = se(e),
                                i = [B, V].indexOf(n) >= 0 ? -1 : 1,
                                r = "function" == typeof s ? s(Object.assign({}, t, {
                                    placement: e
                                })) : s,
                                a = r[0],
                                o = r[1];
                            return a = a || 0, o = (o || 0) * i, [B, q].indexOf(n) >= 0 ? {
                                x: o,
                                y: a
                            } : {
                                x: a,
        ...
        function ge(e, t) {
            return t === G ? me(function (e) {
                ...
                var t, s = T(e),
                    ...
                    r = y(s.scrollWidth, s.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0),
                    a = y(s.scrollHeight, s.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0),
                    o = -n.scrollLeft + A(e),
                    l = -n.scrollTop;
                return "rtl" === O(i || s).direction && (o += y(s.clientWidth, i ? i.clientWidth : 0) - r), {
                    width: r,
                    height: a,
                    x: o,
                    y: l
        ...
        function ve(e, t, s) {
            var n = "clippingParents" === t ? function (e) {
                    var t = $(_(e)),
                        s = ["absolute", "fixed"].indexOf(O(e).position) >= 0,
                        n = s && v(e) ? N(e) : e;
                    return g(n) ? t.filter((function (e) {
                        return g(e) && he(e, n) && "body" !== E(e) && (!s || "static" !== O(e).position)
                    })) : []
                }(e) : [].concat(t),
                i = [].concat(n, [s]),
                r = i[0],
                a = i.reduce((function (t, s) {
                    var n = ge(e, s);
                    return t.top = y(n.top, t.top), t.right = w(n.right, t.right), t.bottom = w(n.bottom, t.bottom), t.left = y(n.left, t.left), t
                }), ge(e, r));
        ...
        function we(e, t) {
            ...
            if (d === R && L) {
                ...
                Object.keys(O).forEach((function (e) {
                    var t = [q, j].indexOf(e) >= 0 ? 1 : -1,
                        s = [V, j].indexOf(e) >= 0 ? "y" : "x";
                    O[e] += k[s] * t
                }))
            }
            return O
                ...
                if (E) {
                    if (r) {
                        var M, $ = "y" === x ? V : B,
                            ...
                            J = K[D],
                            Z = Se(0, T[I], Y[I]),
                            ee = S ? T[I] / 2 - G - Z - Q - L.mainAxis : R - Z - Q - L.mainAxis,
                            te = S ? -T[I] / 2 + G + Z + J + L.mainAxis : U + Z + J + L.mainAxis,
                            re = t.elements.arrow && N(t.elements.arrow),
                            ae = re ? "y" === x ? re.clientTop || 0 : re.clientLeft || 0 : 0,
                            oe = null != (M = null == k ? void 0 : k[x]) ? M : 0,
                            le = z + te - oe,
                    ...
                    if (o) {
                        var de, ue = "x" === x ? V : B,
                            ...
                            ye = ve ? me : fe - T[he] - A[he] - be + L.altAxis,
                            xe = ve ? fe + T[he] + A[he] - be - L.altAxis : ge,
                            Ce = f && ve ? function (e, t, s) {
                                var n = Se(e, t, s);
                                return n > s ? s : n
                            }(ye, fe, xe) : Se(f ? ye : me, fe, f ? xe : ge);
                        E[C] = Ce, _[C] = Ce - fe
                    }
                    t.modifiersData[n] = _
                }
        ...
        const Ce = {
            ...
            fn: function (e) {
                var t, s = e.state,
                    ...
                    o = se(s.placement),
                    l = ie(o),
                    c = [B, q].indexOf(o) >= 0 ? "height" : "width";
                if (r && a) {
                    var d = function (e, t) {
            ...
            effect: function (e) {
                ...
                null != n && ("string" != typeof n || (n = t.elements.popper.querySelector(n))) && he(t.elements.popper, n) && (t.elements.arrow = n)
            },
            requires: ["popperOffsets"],
        ...
        function Te(e) {
            return [V, q, j, B].some((function (t) {
                return e[t] >= 0
            }))
        }
        var Ae = Z({
                defaultModifiers: [te, {
                    ...
                    fn: function (e) {
                        ...
                        if (!t.modifiersData[n]._skip) {
                            for (var i = s.mainAxis, r = void 0 === i || i, a = s.altAxis, o = void 0 === a || a, l = s.fallbackPlacements, c = s.padding, d = s.boundary, u = s.rootBoundary, p = s.altBoundary, f = s.flipVariations, h = void 0 === f || f, m = s.allowedAutoPlacements, g = t.options.placement, v = se(g), b = l || (v === g || !h ? [ue(g)] : function (e) {
                                    if (se(e) === z) return [];
                                    var t = ue(e);
                                    return [fe(e), t, fe(t)]
                                }(g)), y = [g].concat(b).reduce((function (e, s) {
                                    return e.concat(se(s) === z ? function (e, t) {
                                        void 0 === t && (t = {});
                                        var s = t,
                                            n = s.placement,
                                            i = s.boundary,
                                ...
                                }), []), w = t.rects.reference, S = t.rects.popper, x = new Map, C = !0, E = y[0], T = 0; T < y.length; T++) {
                                var A = y[T],
                                    O = se(A),
                                    L = ne(A) === W,
                                    k = [V, j].indexOf(O) >= 0,
                                ...
                                var $ = ue(M),
                                    D = [];
                                if (r && D.push(_[O] <= 0), o && D.push(_[M] <= 0, _[$] <= 0), D.every((function (e) {
                                        return e
                                    }))) {
                                    E = A, C = !1;
                                    break
        ...
        function et() {
            Je.isTouch || (Je.isTouch = !0, window.performance && document.addEventListener("mousemove", tt))
        }

        function tt() {
            var e = performance.now();
            e - Ze < 20 && (Je.isTouch = !1, document.removeEventListener("mousemove", tt)), Ze = e
        }
        ...
        var nt = !!("undefined" != typeof window && "undefined" != typeof document) && !!window.msCrypto;
        var it = {
                animateFill: !1,
                followCursor: !1,
                inlinePositioning: !1,
        ...
        function lt(e, t) {
            var s = Object.assign({}, t, {
                ...
                return (t ? Object.keys(ot(Object.assign({}, rt, {
                    plugins: t
                }))) : at).reduce((function (t, s) {
            ...
            return s.aria = Object.assign({}, rt.aria, s.aria), s.aria = {
        ...
        function dt(e) {
            var t = He();
            return !0 === e ? t.className = ke : (t.className = Pe, We(e) ? t.appendChild(e) : ct(t, e)), t
        }

        function ut(e, t) {
            We(t.content) ? (ct(e, ""), e.appendChild(t.content)) : "function" != typeof t.content && (t.allowHTML ? ct(e, t.content) : e.textContent = t.content)
        }
        ...
        function ft(e) {
            ...
            function i(s, n) {
                var i = pt(t),
                    ...
                    a = i.content,
                    o = i.arrow;
                n.theme ? r.setAttribute("data-theme", n.theme) : r.removeAttribute("data-theme"), "string" == typeof n.animation ? r.setAttribute("data-animation", n.animation) : r.removeAttribute("data-animation"), n.inertia ? r.setAttribute("data-inertia", "") : r.removeAttribute("data-inertia"), r.style.maxWidth = "number" == typeof n.maxWidth ? n.maxWidth + "px" : n.maxWidth, n.role ? r.setAttribute("role", n.role) : r.removeAttribute("role"), s.content === n.content && s.allowHTML === n.allowHTML || ut(a, e.props), n.arrow ? o ? s.arrow !== n.arrow && (r.removeChild(o), r.appendChild(dt(n.arrow))) : r.appendChild(dt(n.arrow)) : o && r.removeChild(o)
            }
            return n.className = Oe, n.setAttribute("data-state", "hidden"), ut(n, e.props), t.appendChild(s), s.appendChild(n), i(e.props, e.props), {
                popper: t,
                onUpdate: i
            }
        }
        ...
        function vt(e, t) {
            var s, n, i, r, a, o, l, c, d = lt(e, Object.assign({}, rt, ot(ze(t)))),
                u = !1,
                p = !1,
                f = !1,
                h = !1,
                ...
                y = {
                    ...
                    setProps: function (t) {
                        ...
                        var s = y.props,
                            n = lt(e, Object.assign({}, s, ze(t), {
                                ignoreAttributes: !0
                            }));
                        y.props = n, F(), s.interactiveDebounce !== n.interactiveDebounce && (N(), g = Ne(U, n.interactiveDebounce));
                        s.triggerTarget && !n.triggerTarget ? Ve(s.triggerTarget).forEach((function (e) {
                            e.removeAttribute("aria-expanded")
                        })) : n.triggerTarget && e.removeAttribute("aria-expanded");
                        I(), M(), x && x(s, n);
                        y.popperInstance && (Q(), Z().forEach((function (e) {
                    ...
                    show: function () {
                        ...
                        y.state.isVisible = !0, O() && (S.style.visibility = "visible");
                        M(), B(), y.state.isMounted || (S.style.transition = "none");
                        if (O()) {
                            var r = P(),
                                a = r.box,
                                l = r.content;
                        ...
                        o = function () {
                                ...
                                if (y.state.isVisible && !h) {
                                    if (h = !0, S.offsetHeight, S.style.transition = y.props.moveTransition, O() && y.props.animation) {
                                        var t = P(),
                                            s = t.box,
                                            n = t.content;
                                        Ue([s, n], i), Xe([s, n], "visible")
                                    }
                                    D(), I(), je(gt, y), null == (e = y.popperInstance) || e.forceUpdate(), $("onMount", [y]), y.props.animation && O() && function (e, t) {
                                        H(e, t)
                                    }(i, (function () {
                            ...
                            function () {
                                var e, t = y.props.appendTo,
                                    s = L();
                                e = y.props.interactive && t === Me || "parent" === t ? s.parentNode : Ie(t, [s]);
                    ...
                    hide: function () {
                        ...
                        y.state.isVisible = !1, y.state.isShown = !1, h = !1, u = !1, O() && (S.style.visibility = "hidden");
                        if (N(), z(), M(!0), O()) {
                            var i = P(),
                                r = i.box,
                                a = i.content;
                        ...
                        D(), I(), y.props.animation ? O() && function (e, t) {
                            H(e, (function () {
                    ...
                    hideWithInteractivity: function (e) {
                        0;
                        k().addEventListener("mousemove", g), je(mt, g), g(e)
                    },
                    enable: function () {
                        y.state.isEnabled = !0
                    },
                    ...
                    destroy: function () {
                        0;
                        if (y.state.isDestroyed) return;
                        y.clearDelayTimeouts(), y.unmount(), G(), delete e._tippy, y.state.isDestroyed = !0, $("onDestroy", [y])
                    }
                };
            ...
            return F(), I(), M(), $("onCreate", [y]), d.showOnCreate && ee(), S.addEventListener("mouseenter", (function () {
            ...
            function _(e) {
                return y.state.isMounted && !y.state.isVisible || Je.isTouch || r && "focus" === r.type ? 0 : $e(y.props.delay, e ? 0 : 1, rt.delay)
            }
            ...
            function $(e, t, s) {
                var n;
                (void 0 === s && (s = !0), C.forEach((function (s) {
                    s[e] && s[e].apply(s, t)
            ...
            function I() {
                !E && y.props.aria.expanded && Ve(y.props.triggerTarget || e).forEach((function (e) {
                    y.props.interactive ? e.setAttribute("aria-expanded", y.state.isVisible && e === L() ? "true" : "false") : e.removeAttribute("aria-expanded")
                }))
            }

            function N() {
                k().removeEventListener("mousemove", g), mt = mt.filter((function (e) {
                    return e !== g
                }))
            }
            ...
            function V(t) {
                if (!Je.isTouch || !f && "mousedown" !== t.type) {
                    ...
                    if (!y.props.interactive || !Qe(S, s)) {
                        if (Ve(y.props.triggerTarget || e).some((function (e) {
                                return Qe(e, s)
                            }))) {
            ...
            function B() {
                var e = k();
                e.addEventListener("mousedown", V, !0), e.addEventListener("touchend", V, _e), e.addEventListener("touchstart", q, _e), e.addEventListener("touchmove", j, _e)
            }

            function z() {
                var e = k();
                e.removeEventListener("mousedown", V, !0), e.removeEventListener("touchend", V, _e), e.removeEventListener("touchstart", q, _e), e.removeEventListener("touchmove", j, _e)
            }
            ...
            function W(t, s, n) {
                void 0 === n && (n = !1), Ve(y.props.triggerTarget || e).forEach((function (e) {
            ...
            function R(e) {
                ...
                if (y.state.isEnabled && !K(e) && !p) {
                    ...
                    r = e, l = e.currentTarget, I(), !y.state.isVisible && Fe(e) && mt.forEach((function (t) {
                        return t(e)
                    })), "click" === e.type && (y.props.trigger.indexOf("mouseenter") < 0 || u) && !1 !== y.props.hideOnClick && y.state.isVisible ? s = !0 : ee(e), "click" === e.type && (u = !s), s && !n && te(e)
                }
            }
            ...
            function U(e) {
                ...
                if ("mousemove" !== e.type || !s) {
                    var n = Z().concat(S).map((function (e) {
            ...
            function Y(e) {
                y.props.trigger.indexOf("focusin") < 0 && e.target !== L() || y.props.interactive && e.relatedTarget && S.contains(e.relatedTarget) || te(e)
            }

            function K(e) {
                return !!Je.isTouch && A() !== e.type.indexOf("touch") >= 0
            }
            ...
            function Q() {
                ...
                }), u.push.apply(u, (null == s ? void 0 : s.modifiers) || []), y.popperInstance = Ae(c, S, Object.assign({}, s, {
                    placement: n,
                    onFirstUpdate: o,
                    modifiers: u
                }))
            ...
            function ee(e) {
                ...
                var t = _(!0),
                    ...
                    i = n[0],
                    r = n[1];
                Je.isTouch && "hold" === i && r && (t = r), t ? s = setTimeout((function () {
                    y.show()
                }), t) : y.show()
            }
        ...
        function bt(e, t) {
            ...
            document.addEventListener("touchstart", et, _e), window.addEventListener("blur", st);
        ...
        bt.defaultProps = rt, bt.setDefaultProps = function (e) {
        ...
        function Pt(e) {
            return function (...t) {
                if (void 0 === t[0]) {
                    for (let t = 0; t < this.length; t += 1) kt.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : Lt(this[t]).trigger(e));
                    return this
                }
                return this.on(e, ...t)
            }
        }
        Pt("click"), Pt("blur"), Pt("focus"), Pt("focusin"), Pt("focusout"), Pt("keyup"), Pt("keydown"), Pt("keypress"), Pt("submit"), Pt("change"), Pt("mousedown"), Pt("mousemove"), Pt("mouseup"), Pt("mouseenter"), Pt("mouseleave"), Pt("mouseout"), Pt("mouseover"), Pt("touchstart"), Pt("touchend"), Pt("touchmove"), Pt("resize"), Pt("scroll");
        const _t = {
            addClass: function (...e) {
            ...
            hasClass: function (...e) {
                const t = At(e.map((e => e.split(" "))));
                return Ot(this, (e => t.filter((t => e.classList.contains(t))).length > 0)).length > 0
            },
            ...
            on: function (...e) {
                ...
                function r(e) {
                    ...
                    if (i.indexOf(e) < 0 && i.unshift(e), Lt(t).is(s)) n.apply(t, i);
                        ...
                        for (let t = 0; t < e.length; t += 1) Lt(e[t]).is(s) && n.apply(e[t], i)
                    }
                }
            ...
            next: function (e) {
                return this.length > 0 ? e ? this[0].nextElementSibling && Lt(this[0].nextElementSibling).is(e) ? Lt([this[0].nextElementSibling]) : Lt([]) : this[0].nextElementSibling ? Lt([this[0].nextElementSibling]) : Lt([]) : Lt([])
            },
            nextAll: function (e) {
                const t = [];
                let s = this[0];
            ...
            prev: function (e) {
                if (this.length > 0) {
                    const t = this[0];
                    return e ? t.previousElementSibling && Lt(t.previousElementSibling).is(e) ? Lt([t.previousElementSibling]) : Lt([]) : t.previousElementSibling ? Lt([t.previousElementSibling]) : Lt([])
                }
                return Lt([])
            },
            prevAll: function (e) {
            ...
            parent: function (e) {
                const t = [];
                for (let s = 0; s < this.length; s += 1) null !== this[s].parentNode && (e ? Lt(this[s].parentNode).is(e) && t.push(this[s].parentNode) : t.push(this[s].parentNode));
                return Lt(t)
            },
            parents: function (e) {
                const t = [];
                for (let s = 0; s < this.length; s += 1) {
                    ...
                    for (; n;) e ? Lt(n).is(e) && t.push(n) : t.push(n), n = n.parentNode
                }
                return Lt(t)
            },
            closest: function (e) {
            ...
            children: function (e) {
                ...
                for (let s = 0; s < this.length; s += 1) {
                    ...
                    for (let s = 0; s < n.length; s += 1) e && !Lt(n[s]).is(e) || t.push(n[s])
                }
                return Lt(t)
            },
            filter: function (e) {
            ...
            for (let i = 1; i < e.length; i += 1) {
                ...
                if (null != r && (n = r, !("undefined" != typeof window && void 0 !== window.HTMLElement ? n instanceof HTMLElement : n && (1 === n.nodeType || 11 === n.nodeType)))) {
                    ...
                    for (let s = 0, n = e.length; s < n; s += 1) {
                        ...
                        void 0 !== i && i.enumerable && (Nt(t[n]) && Nt(r[n]) ? r[n].__swiper__ ? t[n] = r[n] : Vt(t[n], r[n]) : !Nt(t[n]) && Nt(r[n]) ? (t[n] = {}, r[n].__swiper__ ? t[n] = r[n] : Vt(t[n], r[n])) : t[n] = r[n])
                    }
                }
            }
            var n;
        ...
        const Ut = {
            ...
            updateSlides: function () {
                ...
                "string" == typeof y && y.indexOf("%") >= 0 && (y = parseFloat(y.replace("%", "")) / 100 * r), e.virtualSize = -y, a ? d.css({
                    ...
                    marginBottom: "",
                    marginTop: ""
                }), n.centeredSlides && n.cssMode && (jt(e.wrapperEl, "--swiper-centered-offset-before", ""), jt(e.wrapperEl, "--swiper-centered-offset-after", ""));
                ...
                if (e.virtualSize = Math.max(e.virtualSize, r) + g, a && o && ("slide" === n.effect || "coverflow" === n.effect) && i.css({
                    ...
                    }), C && e.grid.updateWrapperSize(E, p, t), !n.centeredSlides) {
                    const t = [];
                    for (let s = 0; s < p.length; s += 1) {
                        let i = p[s];
                        n.roundLengths && (i = Math.floor(i)), p[s] <= e.virtualSize - r && t.push(i)
                    }
                ...
                if (Object.assign(e, {
                    ...
                    jt(e.wrapperEl, "--swiper-centered-offset-before", -p[0] + "px"), jt(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - h[h.length - 1] / 2 + "px");
                    const t = -e.snapGrid[0],
                        s = -e.slidesGrid[0];
                    e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
                }
                u !== c && e.emit("slidesLengthChange"), p.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), f.length !== b && e.emit("slidesGridLengthChange"), n.watchSlidesProgress && e.updateSlidesOffset()
            },
            ...
            updateSlidesProgress: function (e = this && this.translate || 0) {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    (u >= 0 && u < t.size - 1 || p > 1 && p <= t.size || u <= 0 && p >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), n.eq(e).addClass(s.slideVisibleClass)), o.progress = i ? -c : c, o.originalProgress = i ? -d : d
                }
            ...
            updateClickedSlide: function (e) {
                ...
                t.clickedSlide = n, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(Mt(n).attr("data-swiper-slide-index"), 10) : t.clickedIndex = i, s.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
            }
        };
        const Xt = {
            ...
            translateTo: function (e = 0, t = this.params.speed, s = !0, n = !0, i) {
                ...
                if (d = n && e > l ? l : n && e < c ? c : e, r.updateProgress(d), a.cssMode) {
                    ...
                    if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -d;
                        ...
                        if (!r.support.smoothScroll) return qt({
                            swiper: r,
                            targetPosition: -d,
                            side: e ? "left" : "top"
                        }), !0;
        ...
        const Kt = {
            slideTo: function (e = 0, t = this.params.speed, s = !0, n, i) {
                ...
                g >= l.length && (g = l.length - 1), (u || o.initialSlide || 0) === (d || 0) && s && r.emit("beforeSlideChangeStart");
                const v = -l[g];
                ...
                let b;
                if (b = a > u ? "next" : a < u ? "prev" : "reset", p && -v === r.translate || !p && v === r.translate) return r.updateActiveIndex(a), o.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== o.effect && r.setTranslate(v), "reset" !== b && (r.transitionStart(s, b), r.transitionEnd(s, b)), !1;
                if (o.cssMode) {
                    const e = r.isHorizontal(),
                        s = p ? v : -v;
                    if (0 === t) {
            ...
            slideToClickedSlide: function () {
                ...
                if (t.loop) {
                    ...
                    i = parseInt(Mt(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - n / 2 || r > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), r = s.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), $t((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r) : r > e.slides.length - n ? (e.loopFix(), r = s.children(`.${t.slideClass}[data-swiper-slide-index="${i}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), $t((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r)
                } else e.slideTo(r)
            }
        ...
        const Qt = {
            loopCreate: function () {
                const e = this,
                    ...
                    i = n.children().length > 0 ? Mt(n.children()[0].parentNode) : n;
                ...
                for (let e = 0; e < o.length; e += 1) i.append(Mt(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        ...
        function Jt(e) {
            ...
            !!r.noSwipingClass && "" !== r.noSwipingClass && l.target && l.target.shadowRoot && e.path && e.path[0] && (c = Mt(e.path[0]));
            const d = r.noSwipingSelector ? r.noSwipingSelector : `.${r.noSwipingClass}`,
                u = !(!l.target || !l.target.shadowRoot);
            if (r.noSwiping && (u ? function (e, t = this) {
                    return function t(s) {
                        return s && s !== xt() && s !== Et() ? (s.assignedSlot && (s = s.assignedSlot), s.closest(e) || t(s.getRootNode().host)) : null
                    }(t)
            ...
            if (Object.assign(i, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), a.startX = p, a.startY = f, i.touchStartTime = Dt(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== l.type) {
                let e = !0;
                c.is(i.focusableElements) && (e = !1), s.activeElement && Mt(s.activeElement).is(i.focusableElements) && s.activeElement !== c[0] && s.activeElement.blur();
        ...
        function Zt(e) {
            ...
            if (n.isTouchEvent && t.activeElement && l.target === t.activeElement && Mt(l.target).is(n.focusableElements)) return n.isMoved = !0, void(s.allowClick = !1);
            ...
            if (void 0 === n.isScrolling) {
                let e;
                s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? n.isScrolling = !1 : p * p + f * f >= 25 && (e = 180 * Math.atan2(Math.abs(f), Math.abs(p)) / Math.PI, n.isScrolling = s.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle)
            }
        ...
        function es(e) {
            ...
            if (d > n.longSwipesMs) {
                ...
                "next" === t.swipeDirection && (h >= n.longSwipesRatio ? t.slideTo(p + m) : t.slideTo(p)), "prev" === t.swipeDirection && (h > 1 - n.longSwipesRatio ? t.slideTo(p + m) : t.slideTo(p))
            } else {
        ...
        const as = (e, t) => {
            ...
            (n.preventClicks || n.preventClicksPropagation) && r[d]("click", e.onClick, !0), n.cssMode && a[d]("scroll", e.onScroll), n.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", ts, !0) : e[u]("observerUpdate", ts, !0)
        };
        const os = {
                attachEvents: function () {
                    ...
                    e.onTouchStart = Jt.bind(e), e.onTouchMove = Zt.bind(e), e.onTouchEnd = es.bind(e), s.cssMode && (e.onScroll = ns.bind(e)), e.onClick = ss.bind(e), n.touch && !is && (t.addEventListener("touchstart", rs), is = !0), as(e, "on")
                },
        ...
        const cs = {
            setBreakpoint: function () {
                ...
                }), u && !h ? e.disable() : !u && h && e.enable(), e.currentBreakpoint = o, e.emit("_beforeBreakpoint", l), f && s && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", l)
            },
        ...
        const fs = {
                ...
                transition: {
                    ...
                    transitionStart: function (e = !0, t) {
                        ...
                        n.cssMode || (n.autoHeight && s.updateAutoHeight(), Yt({
                            swiper: s,
                            runCallbacks: e,
                            direction: t,
                            step: "Start"
                    ...
                    transitionEnd: function (e = !0, t) {
                        ...
                        s.animating = !1, n.cssMode || (s.setTransition(0), Yt({
                            swiper: s,
                            runCallbacks: e,
                            direction: t,
                            step: "End"
                ...
                images: {
                    loadImage: function (e, t, s, n, i, r) {
                        ...
                        Mt(e).parent("picture")[0] || e.complete && i ? l() : t ? (o = new a.Image, o.onload = l, o.onerror = l, n && (o.sizes = n), s && (o.srcset = s), t && (o.src = t)) : l()
                    },
        ...
        class ms {
            constructor(...e) {
                let t, s;
                if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = Vt({}, s), t && !s.el && (s.el = t), s.el && Mt(s.el).length > 1) {
                    const e = [];
                    return Mt(s.el).each((t => {
                        const n = Vt({}, s, {
                            el: t
                        });
                        e.push(new ms(n))
                ...
                const n = this;
                n.__swiper__ = !0, n.support = Wt(), n.device = Ft({
                    userAgent: s.userAgent
                }), n.browser = Gt(), n.eventsListeners = {}, n.eventsAnyListeners = [], n.modules = [...n.__modules__], s.modules && Array.isArray(s.modules) && n.modules.push(...s.modules);
                const i = {};
                n.modules.forEach((e => {
                    e({
                        swiper: n,
                ...
                const r = Vt({}, us, i);
                return n.params = Vt({}, r, hs, s), n.originalParams = Vt({}, n.params), n.passedParams = Vt({}, s), n.params && n.params.on && Object.keys(n.params.on).forEach((e => {
                    n.on(e, n.params.on[e])
                })), n.params && n.params.onAny && n.onAny(n.params.onAny), n.$ = Mt, Object.assign(n, {
            ...
            mount(e) {
                ...
                let i = (() => {
                    if (e && e.shadowRoot && e.shadowRoot.querySelector) {
                        const t = Mt(e.shadowRoot.querySelector(n()));
                ...
                if (0 === i.length && t.params.createElements) {
                    ...
                    i = Mt(e), e.className = t.params.wrapperClass, s.append(e), s.children(`.${t.params.slideClass}`).each((e => {
                        i.append(e)
                    }))
                }
            ...
            static use(e) {
                return Array.isArray(e) ? (e.forEach((e => ms.installModule(e))), ms) : (ms.installModule(e), ms)
            }
        }
        ...
        function bs({
            ...
            function c() {
                ...
                if (e.params.navigation = vs(e, e.originalParams.navigation, e.params.navigation, {
            ...
            t({
                ...
                if (e.params.navigation.hideOnClick && !Mt(a).is(r) && !Mt(a).is(i)) {
        ...
        function ws({
            ...
            function c() {
                ...
                if (e.params.loop ? (d = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), d > i - 1 - 2 * e.loopedSlides && (d -= i - 2 * e.loopedSlides), d > u - 1 && (d -= u), d < 0 && "bullets" !== e.params.paginationType && (d = u + d)) : d = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                    const n = e.pagination.bullets;
                    let i, o, u;
                    if (s.dynamicBullets && (r = n.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", r * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (a += d - e.previousIndex, a > s.dynamicMainBullets - 1 ? a = s.dynamicMainBullets - 1 : a < 0 && (a = 0)), i = d - a, o = i + (Math.min(n.length, s.dynamicMainBullets) - 1), u = (o + i) / 2), n.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), c.length > 1) n.each((e => {
                        const t = Mt(e),
                            n = t.index();
                        n === d && t.addClass(s.bulletActiveClass), s.dynamicBullets && (n >= i && n <= o && t.addClass(`${s.bulletActiveClass}-main`), n === i && l(t, "prev"), n === o && l(t, "next"))
                    }));
                    else {
                        const t = n.eq(d),
                            r = t.index();
                ...
                if ("fraction" === s.type && (c.find(ys(s.currentClass)).text(s.formatFractionCurrent(d + 1)), c.find(ys(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
                    let t;
                    t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                    const n = (d + 1) / u;
                    let i = 1,
                        r = 1;
                    "horizontal" === t ? i = n : r = n, c.find(ys(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${r})`).transition(e.params.speed)
                }
                "custom" === s.type && s.renderCustom ? (c.html(s.renderCustom(e, d + 1, u)), n("paginationRender", c[0])) : n("paginationUpdate", c[0]), e.params.watchOverflow && e.enabled && c[e.isLocked ? "addClass" : "removeClass"](s.lockClass)
            }
            ...
            function p() {
                ...
                s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(t.modifierClass + e.params.direction), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", ys(t.bulletClass))
            }
            s("init", (() => {
                u(), d(), c()
            })), s("activeIndexChange", (() => {
                ...
                if (e.params.pagination.el && e.params.pagination.hideOnClick && r.length > 0 && !Mt(i).hasClass(e.params.pagination.bulletClass)) {
        ...
        function Ss({
            ...
            const n = (t, s) => {
                    const {
                        rtl: n
                    } = e, i = Mt(t), r = n ? -1 : 1, a = i.attr("data-swiper-parallax") || "0";
                    let o = i.attr("data-swiper-parallax-x"),
                        l = i.attr("data-swiper-parallax-y");
                    const c = i.attr("data-swiper-parallax-scale"),
                        d = i.attr("data-swiper-parallax-opacity");
                    if (o || l ? (o = o || "0", l = l || "0") : e.isHorizontal() ? (o = a, l = "0") : (l = a, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * s * r + "%" : o * s * r + "px", l = l.indexOf("%") >= 0 ? parseInt(l, 10) * s + "%" : l * s + "px", null != d) {
                ...
                i = () => {
                    ...
                    t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((e => {
                        ...
                        let a = t.progress;
                        e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (a += Math.ceil(s / 2) - i * (r.length - 1)), a = Math.min(Math.max(a, -1), 1), Mt(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((e => {
                            n(e, a)
                        }))
                    }))
                };
        ...
        function xs({
            ...
            function r() {
                ...
                t.attr("data-swiper-autoplay") && (s = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(i), i = $t((() => {
                    let t;
            ...
            e.autoplay = {
                ...
                if (e.params.autoplay.enabled) {
                    a();
                    xt().addEventListener("visibilitychange", c), e.params.autoplay.pauseOnMouseEnter && (e.$el.on("mouseenter", u), e.$el.on("mouseleave", p))
                }
                ...
                e.$el.off("mouseenter", u), e.$el.off("mouseleave", p), e.autoplay.running && o();
        ...
        function Cs({
            ...
            function r() {
                ...
                const s = t.clickedIndex,
                    n = t.clickedSlide;
                if (n && Mt(n).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
                if (null == s) return;
                let i;
                if (i = t.params.loop ? parseInt(Mt(t.clickedSlide).attr("data-swiper-slide-index"), 10) : s, e.params.loop) {
                    let t = e.activeIndex;
                ...
                if (e.realIndex !== s.realIndex || r) {
                    ...
                    if (s.params.loop) {
                        ...
                        const t = s.slides.eq(l).prevAll(`[data-swiper-slide-index="${e.realIndex}"]`).eq(0).index(),
                            n = s.slides.eq(l).nextAll(`[data-swiper-slide-index="${e.realIndex}"]`).eq(0).index();
                        a = void 0 === t ? n : void 0 === n ? t : n - l == l - t ? s.params.slidesPerGroup > 1 ? n : l : n - l < l - t ? n : t, o = e.activeIndex > e.previousIndex ? "next" : "prev"
                    } else a = e.realIndex, o = a > e.previousIndex ? "next" : "prev";
                    r && (a += "next" === o ? i : -1 * i), s.visibleSlidesIndexes && s.visibleSlidesIndexes.indexOf(a) < 0 && (s.params.centeredSlides ? a = a > l ? a - Math.floor(n / 2) + 1 : a + Math.floor(n / 2) - 1 : a > l && s.params.slidesPerGroup, s.slideTo(a, t ? 0 : void 0))
                }
                let a = 1;
        ...
        window.addEventListener("load", (function (e) {
            ! function () {
                if (Es(), document.querySelector(".main-block__slider") && new gs(".main-block__slider", {
                        modules: [bs, ws, Ss, xs],
                        autoplay: {
                            delay: 3e3,
                        ...
                        on: {
                            init: function (e) {
                                const t = document.querySelector(".fraction-controll__all"),
                                    s = document.querySelectorAll(".slide-main-block:not(.swiper-slide-duplicate)");
                                t.innerHTML = s.length < 10 ? `0${s.length}` : s.length, console.log(e)
                            },
                            slideChange: function (e) {
                                document.querySelector(".fraction-controll__current").innerHTML = e.realIndex + 1 < 10 ? `0${e.realIndex+1}` : e.realIndex + 1
                            }
                        }
                    }), document.querySelector(".products-slider__slider") && new gs(".products-slider__slider", {
                        modules: [bs, ws, xs],
                        autoplay: {
                            delay: 3e3,
                            disableOnInteraction: !1
                        ...
                        on: {}
                    }), document.querySelector(".products-new__slider") && new gs(".products-new__slider", {
                        modules: [bs, ws, xs],
                        observer: !0,
                        observeParents: !0,
                        slidesPerView: 1,
        ...
        document.addEventListener("click", (function (e) {
            ...
            if (t.closest("[data-parent]")) {
                ...
                if (n) {
                    ...
                    e && e !== t && (e.classList.remove("_sub-menu-active"), s.classList.remove("_sub-menu-open"), document.querySelector(".sub-menu-catalog").classList.remove("_sub-menu-open")), document.querySelector(".sub-menu-catalog").classList.toggle("_sub-menu-open"), t.classList.toggle("_sub-menu-active"), n.classList.toggle("_sub-menu-open")
                } else console.log("Ой, нет такого подменю :(");
                e.preventDefault()
            }
            t.closest(".menu-top-header__link_catalog") && (document.documentElement.classList.add("catalog-open"), e.preventDefault());
            t.closest(".menu-catalog__back") && (document.documentElement.classList.remove("catalog-open"), document.querySelector("._sub-menu-active") && document.querySelector("._sub-menu-active").classList.remove("_sub-menu-active"), document.querySelector("._sub-menu-open") && document.querySelector("._sub-menu-open").classList.remove("_sub-menu-active"));
            if (t.closest(".sub-menu-catalog__back")) {
                const e = document.querySelectorAll("._sub-menu-open"),
                    t = document.querySelectorAll("._sub-menu-active");
                e && e.forEach((e => e.classList.remove("_sub-menu-open"))), t && t.forEach((e => e.classList.remove("_sub-menu-active")))
            }
        }));
        const Ts = document.querySelectorAll(".sub-menu-catalog__block");
        Ts.length > 0 && Ts.forEach((e => {
            ...
            function () {
                ...
                e && e.addEventListener("click", (function (e) {
                    ...
                    })(), document.documentElement.classList.toggle("menu-open"), document.documentElement.classList.contains("catalog-open") && document.documentElement.classList.remove("catalog-open"))
                }))
            }(),
            function () {
                ...
                if (e.length > 0) {
                    ...
                    if (s.length > 0) {
                        ...
                        s.forEach((t => {
                            ...
                            s.value = n[0], s.type = n[1] ? n[1].trim() : "max", s.item = t, e.push(s)
                        }));
                    ...
                    function o(e) {
                        ...
                        if (t.hasAttribute("data-spoller") || t.closest("[data-spoller]")) {
                            const s = t.hasAttribute("data-spoller") ? t : t.closest("[data-spoller]"),
                                n = s.closest("[data-spollers]"),
                                i = !!n.hasAttribute("data-one-spoller");
                            n.querySelectorAll("._slide").length || (i && !s.classList.contains("_spoller-active") && l(n), s.classList.toggle("_spoller-active"), a(s.nextElementSibling, 500)), e.preventDefault()
                        }
                    }

                    function l(e) {
                        const t = e.querySelector("[data-spoller]._spoller-active");
                        t && (t.classList.remove("_spoller-active"), i(t.nextElementSibling, 500))
                    }
                }
            }(),
            function () {
                ...
                if (e.length > 0) {
                    ...
                    i.startsWith("tab-") && (t = i.replace("tab-", "").split("-")), e.forEach(((e, s) => {
                        e.classList.add("_tab-init"), e.setAttribute("data-tabs-index", s), e.addEventListener("click", n),
                            function (e) {
                                ...
                                n.length > 0 && n.forEach(((e, n) => {
                                    s[n].setAttribute("data-tabs-title", ""), e.setAttribute("data-tabs-item", ""), r && n == t[1] && s[n].classList.add("_tab-active"), e.hidden = !s[n].classList.contains("_tab-active")
                                }))
                            }(e)
                    }));
                    const r = Array.from(e).filter((function (e, t, s) {
                ...
                function s(e, t) {
                    e.forEach((e => {
                        ...
                        e.querySelectorAll("[data-tabs-item]").forEach(((r, a) => {
                            t.matches ? (i.append(n[a]), i.append(r), e.classList.add("_tab-spoller")) : (s.append(n[a]), e.classList.remove("_tab-spoller"))
                        }))
                    }))
                }
                ...
                function n(e) {
                    ...
                    if (t.closest("[data-tabs-title]") || t.hasAttribute("[data-tabs-title]")) {
                        ...
                        if (!s.classList.contains("_tab-active") && !n.querySelectorAll("._slide").length) {
                            const e = n.querySelector("[data-tabs-title]._tab-active");
                            e && e.classList.remove("_tab-active"), s.classList.add("_tab-active"),
                                function (e) {
                                    ...
                                    s.length > 0 && s.forEach(((e, s) => {
                                        t[s].classList.contains("_tab-active") ? (a ? r(e, a) : e.hidden = !1, location.hash = `tab-${n}-${s}`) : a ? i(e, a) : e.hidden = !0
                                    }))
                                }(n)
                        }
                        e.preventDefault()
            ...
            function () {
                ...
                e.length && e.forEach((e => {
                    ...
                    const t = e.target;
                    "INPUT" !== t.tagName && "TEXTAREA" !== t.tagName || (t.dataset.placeholder && (t.placeholder = t.dataset.placeholder), t.classList.remove("_focus"), t.parentElement.classList.remove("_focus"), t.hasAttribute("data-validate") && d.validateInput(t))
                }))
            }(),
            function (e) {
                const t = document.forms;
                if (t.length)
                    for (const e of t) e.addEventListener("submit", s);
                async function s(t) {
                    const s = t.target;
                    if (0 === (e ? d.getErrors(s) : 0)) {
                        const e = s.getAttribute("data-message");
                        if (s.hasAttribute("data-ajax")) {
                            t.preventDefault();
                            const n = s.getAttribute("action") ? s.getAttribute("action").trim() : "#",
                                i = s.getAttribute("method") ? s.getAttribute("method").trim() : "GET",
                                r = new FormData(s);
                            s.classList.add("_sending");
                            ...
                            if (a.ok) {
                                await a.json();
                                s.classList.remove("_sending"), e && popupItem.open(`#${e}`), d.formClean(s)
                            } else alert("Ошибка"), s.classList.remove("_sending")
                        }
                        s.hasAttribute("data-test") && (t.preventDefault(), e && popupItem.open(`#${e}`), d.formClean(s))
                    } else {
                        const e = s.querySelector("._error");
                        e && s.hasAttribute("data-goto-error") && gotoBlock(e, 1e3, 50), t.preventDefault()
                    }
                }
                    ...
                    function a(e) {
                        ...
                        for (let n = 0; n < t.length; n++) {
                            ...
                            a.addEventListener("mouseenter", (function (t) {
                                ...
                                i(e), e.dataset.ajax ? o(a.value, e) : (s.innerHTML = n + 1, r())
                            }))
                        }
                    }
